...
class Api2CartControllerTest extends TestCase
{
    ...
    public function test_successfull_product_delete()
    {
        ...
        $product_id = $api2cart->getSimpleProductID(self::API2CART_DEMO_STORE_KEY, self::SAMPLE_PRODUCT['model']);
    ...
    public function test_successful_product_update()
    {
        ...
        $product_before = $api2cart->findSimpleProduct(self::API2CART_DEMO_STORE_KEY, self::SAMPLE_PRODUCT['model']);
        ...
        $product_after = $api2cart->findSimpleProduct(self::API2CART_DEMO_STORE_KEY, self::SAMPLE_PRODUCT['model']);
